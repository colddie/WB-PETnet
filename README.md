# WB-PETnet
Minimum Matlab implementation of individual whole-body graph build-up in "Sun, T., Wang, Z., Wu, Y. et al. Identifying the individual metabolic abnormities from a systemic perspective using whole-body PET imaging". Eur J Nucl Med Mol Imaging 49, 2994–3004 (2022). The idea was inspired by "Liu X, Wang Y, Ji H, Aihara K, Chen L. Personalized characterization of diseases using sample-specific networks. Nucleic Acids Res. 2016" but adopted to whole-body image analysis.
...
* Hellman AF, Clegg PS, Marie S, Tournier N & Tavares AAS. Comparing three methodologies for network analysis of human [11C]glyburide whole-body PET data: d-networks, s-networks, and ΔPCC networks. EJNMMI Research, 2025.
2024
